...
public class ModBlocks {
    ...
    public static final Block CUSTOM_LANTERN = registerBlock("custom_lantern", new CustomLanternBlock(FabricBlockSettings.of(Material.GLASS).luminance(15).strength(0.3f, 1.5f).nonOpaque().sounds(BlockSoundGroup.LANTERN)), ModItemGroup.TEMPLATE_GROUP);
